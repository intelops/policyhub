...
#ValidatingWebhook: {
	...
	// +listMapKey=name
	// +optional
	matchConditions?: [...#MatchCondition] @go(MatchConditions,[]MatchCondition) @protobuf(11,bytes,rep)
}
...
#MutatingWebhook: {
	...
	// +listMapKey=name
	// +optional
	matchConditions?: [...#MatchCondition] @go(MatchConditions,[]MatchCondition) @protobuf(12,bytes,rep)
}
